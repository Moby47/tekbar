          ...
          <div class="row align-items-center">
              <div class="col-lg-7 col-md-12 col-sm-12 order-lg-first mt-lg-0 custom-margin">
                  <h1 class="mb-4 title title-size">
                    ...
                    support experience to your <strong>customers.</strong>
                  </h1>
                  <p>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12">
          <h4 class="section-title">Why Us?</h4>
          <p class="text-center">We’re here to exceed expectations of your customers.</p>
        </div>
      </div>
      ...
      <div class="container">
          <div class="row align-items-center">
              <div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12">
                  ...
                  <p class="text-center">
                       Businesses that want to change the world with us.</p>
              </div>
          </div>
                                  ...
                                  <div class="customers_grid">
                                      ...
                                      <div class="customers-bottom_sur">
                                          <div class="custo_grid">
                                              <h5>Taye</h5>
                                              <span><a href='https://www.hiitplc.com/' target='_blank'>
                                               Link</a></span>
                                          </div>
                                      </div>
                                  </div>
