<template>
          ...
          <div class="row about-content">
              <div class="col-lg-6 info mb-lg-0 mb-5 align-center">
               <!--   <span class="title">Technology</span> -->
                  ...
                  <p class="mt-md-4 mt-3"> We are inspired by our success in connecting customers and service/product providers and their satisfaction from mutual benefits. </p>
  ...
  <section class="">
      <div class="container">
          <div class="row align-items-center">
              <div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12">
                  <h4 class="section-title">Need support?</h4>
                  <p class="text-center">Success is possible through strong communication and deep eagerness to develop, learn and become better.</p>
              </div>
          </div>
        </div>
