            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12">
                        ...
                        <p class="text-center">How we help businesses, individuals triple their profits 
                            using outstanding customer support and services</p>
                    </div>
                </div>
                <div class="row main-cont-wthree-2 mt-5">
                    <div class="col-lg-6 feature-grid-left order2 mt-lg-0 mt-sm-5 mt-4">
                        <h4 class="title-left">Technical support</h4>
                        <p class="text-para">
            ...
            <div class="container">
                <div class="row main-cont-wthree-2">
                    <div class="col-lg-6 feature-grid-left">
                        <h4 class="section-title-left">A custom recruited Customer Support team, 100% dedicated  to your business. Our agents are an extension of your team</h4>
                        <p class="text-para">
                        ...
                        <ul class="list mt-4">
                            <li><span class="fa fa-check"></span> We will improve Your
