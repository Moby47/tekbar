...
<header id="site-header" class="fixed-top">
    <nav class="navbar navbar-expand-lg navbar-dark">
        <nuxt-link  class="navbar-brand" to="/">
            <span class="fa fa-bars"></span> TekBar
        </nuxt-link>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8">
              ...
              <div>
                <p class="">We have teams that build strong relationships with customers.
                <br>  Let’s create your support team.
                  </p>
              </div>
            </div>
            <!-- Quick Links -->
  ...
  <button onclick="topFunction()" id="movetop" class="bg-primary" title="Go to top">
    ...
    <script>
        ...
        })(window,document,'https://cdn.bitrix24.com/b16541281/crm/site_button/loader_2_lq1g5x.js');
</script>
